            ...
            <SheetContent className="w-[80%]">
                ...
                <div className="mt-6">
                    ...
                    <div className="space-y-3">
                        {booking.service.barberShop.phones.map(
                            (phone, index) => (
                            ...
                            <Dialog>
                                ...
                                <DialogContent className="w-[80%] rounded-xl">
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Ao cancelar esta reserva, você
                                            perderá a vaga e precisará realizar
                                            uma nova reserva para garantir seu
                                            horário. Tem certeza de que deseja
